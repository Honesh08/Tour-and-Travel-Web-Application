...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public CheckHotels() {
        ...
        caption.setFont(new Font("Rockwell", Font.PLAIN, 35));
        add(caption);

        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/ho1.jpg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/ho2.jpg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/ho3.jpg"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons/ho4.jpg"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/ho5.jpg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icons/ho6.jpg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icons/ho7.jpg"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icons/ho8.jpg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("icons/ho9.jpg"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icons/ho10.jpg"));
